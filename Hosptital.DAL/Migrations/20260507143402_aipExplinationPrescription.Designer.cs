...
namespace Hosptital.DAL.Migrations
{
    ...
    [Migration("20260507143402_aipExplinationPrescription")]
    partial class aipExplinationPrescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hosptital.DAL.Entities.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hosptital.DAL.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hosptital.DAL.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hosptital.DAL.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hosptital.DAL.Entities.Admin", b =>
                {
                    b.HasOne("Hosptital.DAL.Entities.Base.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("Hosptital.DAL.Entities.Admin", "UserId")
            ...
            modelBuilder.Entity("Hosptital.DAL.Entities.Conversation", b =>
                {
                    b.HasOne("Hosptital.DAL.Entities.Booking", "Appointment")
                        .WithMany()
            ...
            modelBuilder.Entity("Hosptital.DAL.Entities.Message", b =>
                {
                    b.HasOne("Hosptital.DAL.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Hosptital.DAL.Entities.Treatment", b =>
                {
                    b.HasOne("Hosptital.DAL.Entities.Prescription", null)
                        .WithMany("Treatments")
